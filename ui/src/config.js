    ...
    },
    {
      label: '系统管理', options: [
        {label: '组织管理', icon: 'fas fa-building', children: [
            {label: '用户管理', icon: 'fas fa-users', link: '/user', pageType: 'manage'},
            {label: '部门管理', icon: 'fas fa-building', link: '/department', pageType: 'manage'},
          ]
        },
        {label: '权限管理', icon: 'fas fa-shield-alt', children: [
            {label: '角色管理', icon: 'fas fa-user-tag', link: '/role', pageType: 'manage'},
            {label: '权限管理', icon: 'fas fa-shield-alt', link: '/privilege', pageType: 'manage'},
            {label: '鉴权规则', icon: 'fas fa-user-shield', link: '/filter-chain', pageType: 'manage'},
          ]
        },
        {label: '系统监控', icon: 'fas fa-chart-line', children: [
            {label: 'Druid监控', icon: 'fas fa-database', link: '/druid/index.html', pageType: 'iframe'}
          ]
        },
        {label: '消息推送', icon: 'fas fa-comment-alt'},
        {label: '开发工具', icon: 'fas fa-toolbox', children: [
            {label: '接口文档', icon: 'fas fa-code', link: '/swagger-ui.html', pageType: 'iframe'},
