<template>
  <a-form>
    <a-form-item label="权限Key" :labelCol="$style.form.label" :wrapperCol="$style.form.wrapper" required>
      <a-input v-model="privilege.privilegeKey" placeholder="请填写权限Key，不能与其他权限Key重复"></a-input>
    </a-form-item>
    <a-form-item label="权限名称" :labelCol="$style.form.label" :wrapperCol="$style.form.wrapper" required>
      <a-input v-model="privilege.name" placeholder="请填写权限名称"></a-input>
    </a-form-item>
    <a-form-item label="权限类型" :labelCol="$style.form.label" :wrapperCol="$style.form.wrapper" required>
    ...
    <a-form-item label="权限描述" :labelCol="$style.form.label" :wrapperCol="$style.form.wrapper" required>
